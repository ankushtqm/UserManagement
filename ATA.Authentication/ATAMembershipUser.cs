...
namespace ATA.Authentication
{
    ...
    public class ATAMembershipUser : MembershipUser
    {
        ...
        public ATAMembershipUser(string providerName, string name, object providerUserKey, string email, DateTime creationDate,
            ...
            DateTime ExpirationDate, DateTime LastUpdatedDate, bool IsActiveMB, bool IsActiveFF, bool IsActiveACH, bool IsATAStaff,
            bool IsAcceptedLicense, int CreatingUserId, int LastUpdatingUserId, string Email2, string PreferredName,
            bool IsPrivate, bool RequiresPasswordChange, DateTime LastLoginDate,string Address1, string Address2, string City, string State, string Zipcode, string Province, string Country)
        ...
        #region LoadChildCollections

        public void LoadChildCollections()
        {
            if (this.UserId > 0)
            {
        ...
        private void LoadChildAddresses()
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@UserId", this.UserId);
            this._userAddresses = new DataObjectList<UserAddress>(sqlParams, ATAMembershipUser.UserAddressCollectionLoad);
        } 

        private void LoadChildIssues()
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@UserId", this.UserId);
            this._userIssues = new DataObjectList<UserIssue>(sqlParams, ATAMembershipUser.UserIssueCollectionLoad);
        }
        ...
        private void LoadChildCompanies()
        {
            SqlParameter[] sqlParams = new SqlParameter[1];
            sqlParams[0] = new SqlParameter("@UserId", this.UserId);
            this._userCompanies = new DataObjectList<UserCompany>(sqlParams, ATAMembershipUser.UserCompanyCollectionLoad);
        }
        ...
        private void LoadChildGroups()
        {
            ...
            this._userGroups = new DataObjectList<UserGroup>(sqlParams, ATAMembershipUser.UserGroupCollectionLoad);
        }

        private void LoadChildMemberTypes()
        {
            SqlParameter[] sqlParams = new SqlParameter[2];
            sqlParams[0] = new SqlParameter("@UserId", this.UserId);
            sqlParams[1] = new SqlParameter("@AppliesToSiteId", (int)ATAMembershipUtility.Instance.CurrentSite);
            this._userMemberTypes = new DataObjectList<UserMemberType>(sqlParams, ATAMembershipUser.UserMemberTypeCollectionLoad);
        }
        ...
        public bool IsActiveACH
        {
            get { return (this._IsActiveACH); }
            set { this._IsActiveACH = value; }
        }
        ...
        public void AddGroup(int GroupId, int CommitteeRoleId, bool reloadGroups, ATAMembershipProvider provider, string LyrisListName)
        {
            ...
            LyrisMember.AddMemberToList(this.Email, this.PreferredName, LyrisListName);
            if (reloadGroups)
                this.LoadChildGroups();
        } 
