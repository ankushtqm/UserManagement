...
(function (AutoCompleteExample) {
    ...
    var ViewModel = (function () {
        ...
        ViewModel.prototype.selectLanguage = function (event, ui) {
            ...
            var cname = UsernCompname.substring(startindex + 1).replace(')', ''); //Get the Company out of the Company Name.
            ...
            $.ajax({
                ...
                contentType: 'application/json',
                success: function (data) {
                    ViewModel.prototype.selectedValues.push({ "Name": usrname, "UserId": ui.item.text, role: true, GroupId: ViewModel.prototype.gId(), CompanyName: cname });
                    ViewModel.prototype.InfoMessage("User " + usrname + " has been successfully added successfully!");
        ...
        ViewModel.prototype.selectChair = function (event, ui) {
            ...
            if (ui.item.label) {
                ...
                if ((txtprim !== null) && txtprim.val().length > 0) {
                    $('#spnMessage').html("You already have a primary representative for " + company + ".  Select another company chair or delete the contact below.").css("color", "red");
                    return false;
                }
                else { 
            ...
            if (!(company.length > 0)) {
                ...
                $('#spnMessage').html("No company name found for Chair. So the selection could not be completed");
                return false;
            }
        ...
        ViewModel.prototype.load = function (groupid, roleid) {
            ...
            $.ajax({
                ...
                error: function (exception) { ViewModel.prototype.errorMessage('Exception in Participant/Informational user list:' + exception.responseText); }
            });
        }
        /////////////////////////////////////////////////////
        ...
        ViewModel.prototype.RemoveGroupUser = function (URL) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#spnMessage').html("User removed successfully!!").css("color", "green");
                },
                error: function (xhr, status, error) {
                    var err = eval("(" + xhr.responseText + ")"); 
                    $('#spnMessage').html("Error removing user!:" + xhr.responseText).css("color", "red");
                ...
                if (!match) {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            self.infoMessage("Successfully added the user!");
                        },
                        error: function (xhr, status, error) {
